...
export default function Page() {
  return (
    <RecordWorkbench
      ...
      subtitle="Pay vendor bills — settlement account is auto-suggested (Bank / Cash)."
      endpoint="/accounts/payable/payments"
      fields={[
        { key: 'payable_id', label: 'Invoice', type: 'select', optionsKey: 'invoices', required: true },
